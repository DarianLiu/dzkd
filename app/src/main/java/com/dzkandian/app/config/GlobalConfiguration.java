...
import com.dzkandian.app.config.imageloader.CustomLoaderStrategy;
...
//    public static String sDomain = Api.APP_DOMAIN;
    ...
    @Override
    public void applyOptions(Context context, @NonNull GlobalConfigModule.Builder builder) {
        if (!BuildConfig.LOG_DEBUG) { //Release 时,让框架不再打印 Http 请求和响应的信息
            builder.printHttpLogLevel(RequestInterceptor.Level.NONE);
        }else {
            builder.printHttpLogLevel(RequestInterceptor.Level.RESPONSE);
        }
...
//                                                  List<String> segments, String icon_errorr_empty_message, String responseUrl) {
...
//                    okhttpBuilder.sslSocketFactory(); //支持 Https,详情请百度
    ...
    @Override
    public void injectAppLifecycle(Context context, @NonNull List<AppLifecycles> lifecycles) {
    ...
    @Override
    public void injectActivityLifecycle(Context context, @NonNull List<Application.ActivityLifecycleCallbacks> lifecycles) {
    ...
    @Override
    public void injectFragmentLifecycle(Context context, @NonNull List<FragmentManager.FragmentLifecycleCallbacks> lifecycles) {
        lifecycles.add(new FragmentManager.FragmentLifecycleCallbacks() {

            @Override
            public void onFragmentCreated(FragmentManager fm, @NonNull Fragment f, Bundle savedInstanceState) {

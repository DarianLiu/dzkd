...
public class GestureCover extends BaseCover implements OnTouchGestureListener {
    ...
    public View onCreateCoverView(Context context) {
        return View.inflate(context, R.layout.player_gesture_cover, null);
    }
    ...
    private void onRightVerticalSlide(float percent) {
        ...
        // 显示
        setVolumeIcon(i == 0 ? R.drawable.player_gesture_volume_off_white : R.drawable.player_gesture_volume_up_white);

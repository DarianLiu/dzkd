...
public class RegexUtils {
     ...
     */
    private static final String REGEX_USERNAME = "^[\\w\\u4e00-\\u9fa5]{3,16}(?<!_)$";
    /**
     * 正则：密码，取值范围为含有小写字母、大写字母、数字、特殊符号的两种及以上,必须是6-16位
     */
    private static final String REGEX_PASSWORD = "^(?![A-Z]+$)(?![a-z]+$)(?!\\d+$)(?![\\W_]+$)\\S{6,16}$";
    /**
     * 正则：密码(简单)，取值范围为含有小写字母、大写字母、数字的两种及以上,必须是6-12位
     */
    private static final String REGEX_PASSWORD_SIMPLE = "^(?![A-Z]+$)(?![a-z]+$)(?!\\d+$)\\S{6,12}$";
    /**
     ...
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
    public static boolean isMatch(@NonNull String regex, @Nullable CharSequence input) {
     ...
     */
    @Nullable
    public static List<String> getMatches(@NonNull String regex, @Nullable CharSequence input) {
     ...
     */
    @Nullable
    public static String[] getSplits(@Nullable String input, @NonNull String regex) {
        if (input == null) return null;
     ...
     */
    @Nullable
    public static String getReplaceFirst(@Nullable String input, @NonNull String regex, @NonNull String replacement) {
        if (input == null) return null;
     ...
     */
    @Nullable
    public static String getReplaceAll(@Nullable String input, @NonNull String regex, String replacement) {
        if (input == null) return null;

...
public class DownloadService extends Service {
    ...
    private DownloadService.DownloadBinder binder = new DownloadService.DownloadBinder();
...
//    }
    ...
    private HttpManager.FileCallback mFileDownloadCallBack;
...
//            channel.setVibrationPattern(new long[]{100, 200, 300, 400, 500, 400, 300, 200, 400});
        ...
        mBuilder.setContentTitle("开始下载")
                ...
                .setSmallIcon(R.drawable.update_app_update_icon)
     ...
     * 下载模块
     */
    private void startDownload(UpdateAppBean updateApp, final DownloadService.DownloadCallback callback) {
        ...
        mFileDownloadCallBack = new HttpManager.FileCallback() {
            @Override
            ...
            public void onError(String error) {
                Toast.makeText(DownloadService.this, "网络请求失败，请连网后重试", Toast.LENGTH_SHORT).show();
                //App前台运行
                if (callback != null) {
            ...
            public void onResponse(File file) {
                ...
                try {
                    if (AppUpdateUtils.isAppOnForeground(DownloadService.this) || mBuilder == null) {
                        ...
                        if (callback != null) {
                            boolean temp = callback.onInstallAppAndAppOnForeground(file);
                            if (!temp) {
        ...
        updateApp.getHttpManager().download(apkUrl, target, appName, mFileDownloadCallBack);
    }
    ...
    public class DownloadBinder extends Binder {
         ...
         * @param callback  下载回调
         */
        public void start(UpdateAppBean updateApp, DownloadService.DownloadCallback callback) {
            //下载

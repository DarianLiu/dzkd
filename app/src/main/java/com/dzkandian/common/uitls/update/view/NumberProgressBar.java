package com.dzkandian.common.uitls.update.view;
...
public class NumberProgressBar extends View{
     ...
     * Listener
     */
    private NumberProgressBar.OnProgressBarListener mListener;
...
//        mCicrlePaint.setColor(Color.parseColor("#66ff6666"));
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            setProgressTextVisibility(bundle.getBoolean(INSTANCE_TEXT_VISIBILITY) ? NumberProgressBar.ProgressTextVisibility.VISIBLE : NumberProgressBar.ProgressTextVisibility.INVISIBLE);
    ...
    public void setProgressTextVisibility(NumberProgressBar.ProgressTextVisibility visibility) {
        mIfDrawText = visibility == NumberProgressBar.ProgressTextVisibility.VISIBLE;
        invalidate();
    }

    public void setOnProgressBarListener(NumberProgressBar.OnProgressBarListener listener) {
        mListener = listener;
    }

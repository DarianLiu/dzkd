...
public class WheelView extends View {
    ...
    /** 当前值和标签的颜色 */ 
    private static final int VALUE_TEXT_COLOR = 0xFFD4221C;
...
//        setBackgroundResource(R.drawable.rectangle_shape); 
     ...
     * @return 
     */ 
    private int getDesiredHeight(@Nullable Layout layout) {
        if (layout == null) { 
            return 0; 
        } 
...
//        drawShadows(canvas); 
     ...
     */ 
    private void drawShadows(@NonNull Canvas canvas) {
     ...
     * @param canvas the canvas for drawing 
     */ 
    private void drawValue(@NonNull Canvas canvas) {
     ...
     * @param canvas the canvas for drawing 
     */ 
    private void drawItems(@NonNull Canvas canvas) {
        canvas.save(); 
     ...
     * @param canvas the canvas for drawing 
     */ 
    private void drawCenterRect(@NonNull Canvas canvas) {
    ...
    /** 
     * Set next icon_errorr_empty_message to queue. Clears queue before.
     *  
     * @param message the icon_errorr_empty_message to set
     */ 

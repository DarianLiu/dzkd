package com.dzkandian.common.widget.likeview;
...
public class ShineView extends View {
    ...
    public void showAnimation(ShineButton shineButton) {
        ...
        Log.e("myshineButtonX",location[0] + "");
        Log.e("myshineButtonY",location[1] + "");
...
//            centerAnimY = getMeasuredHeight() - shineButton.getBottomHeight(false) + btnHeight / 2;
        ...
        Log.e("mycenterAnimX",centerAnimX+"");
        Log.e("mycenterAnimY",centerAnimY+"");
        clickAnimator.start();
    }

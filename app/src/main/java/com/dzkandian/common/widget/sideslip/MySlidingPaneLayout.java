package com.dzkandian.common.widget.sideslip;
...
public class MySlidingPaneLayout extends ViewGroup {
    ...
    private MySlidingPaneLayout.PanelSlideListener mPanelSlideListener;
    ...
    final ArrayList<MySlidingPaneLayout.DisableLayerRunnable> mPostedRunnables = new ArrayList<>();

    static final MySlidingPaneLayout.SlidingPanelLayoutImpl IMPL;

    static {
        if (Build.VERSION.SDK_INT >= 17) {
            IMPL = new MySlidingPaneLayout.SlidingPanelLayoutImplJBMR1();
        } else if (Build.VERSION.SDK_INT >= 16) {
            IMPL = new MySlidingPaneLayout.SlidingPanelLayoutImplJB();
        } else {
            IMPL = new MySlidingPaneLayout.SlidingPanelLayoutImplBase();
        }
    }
    ...
    /**
     * No-op stubs for {@link MySlidingPaneLayout.PanelSlideListener}. If you only want to implement a subset
     * of the listener methods you can extend this instead of implement the full interface.
     */
    public static class SimplePanelSlideListener implements MySlidingPaneLayout.PanelSlideListener {
        @Override
    ...
    public MySlidingPaneLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        ViewCompat.setAccessibilityDelegate(this, new MySlidingPaneLayout.AccessibilityDelegate());
        ViewCompat.setImportantForAccessibility(this, ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_YES);

        mDragHelper = ViewDragHelper.create(this, 0.5f, new MySlidingPaneLayout.DragHelperCallback());
    ...
    public void setPanelSlideListener(@Nullable MySlidingPaneLayout.PanelSlideListener listener) {
    ...
    protected void onDetachedFromWindow() {
        ...
        for (int i = 0, count = mPostedRunnables.size(); i < count; i++) {
            final MySlidingPaneLayout.DisableLayerRunnable dlr = mPostedRunnables.get(i);
            dlr.run();
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            final View child = getChildAt(i);
            final MySlidingPaneLayout.LayoutParams lp = (MySlidingPaneLayout.LayoutParams) child.getLayoutParams();
            ...
            if (lp.width == MySlidingPaneLayout.LayoutParams.WRAP_CONTENT) {
                childWidthSpec = View.MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin,
                        View.MeasureSpec.AT_MOST);
            } else if (lp.width == MySlidingPaneLayout.LayoutParams.MATCH_PARENT) {
                childWidthSpec = View.MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin,
            ...
            int childHeightSpec;
            if (lp.height == MySlidingPaneLayout.LayoutParams.WRAP_CONTENT) {
                childHeightSpec = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight, View.MeasureSpec.AT_MOST);
            } else if (lp.height == MySlidingPaneLayout.LayoutParams.MATCH_PARENT) {
                childHeightSpec = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight, View.MeasureSpec.EXACTLY);
            } else {
            ...
            if (heightMode == View.MeasureSpec.AT_MOST && childHeight > layoutHeight) {
                ...
                if (canSlide && child != mSlideableView) {
                    if (lp.width < 0 && (measuredWidth > fixedPanelWidthLimit || lp.weight > 0)) {
                        ...
                        if (skippedFirstPass) {
                            ...
                            if (lp.height == MySlidingPaneLayout.LayoutParams.WRAP_CONTENT) {
                                childHeightSpec = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight,
                                        View.MeasureSpec.AT_MOST);
                            } else if (lp.height == MySlidingPaneLayout.LayoutParams.MATCH_PARENT) {
                                childHeightSpec = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight,
                                        View.MeasureSpec.EXACTLY);
                            } else {
                                childHeightSpec = View.MeasureSpec.makeMeasureSpec(lp.height,
                                        View.MeasureSpec.EXACTLY);
                            }
                        } else {
                        ...
                        final int childWidthSpec = View.MeasureSpec.makeMeasureSpec(
                                fixedPanelWidthLimit, View.MeasureSpec.EXACTLY);
                        child.measure(childWidthSpec, childHeightSpec);
                    }
                } else if (lp.weight > 0) {
                    int childHeightSpec;
                    ...
                    if (canSlide) {
                        ...
                        final int childWidthSpec = View.MeasureSpec.makeMeasureSpec(
                                measuredWidth + addedWidth, View.MeasureSpec.EXACTLY);
                        child.measure(childWidthSpec, childHeightSpec);
                    }
                }
            }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mFirstLayout) {
            if (mCanSlide) {
                ...
                if (((MySlidingPaneLayout.LayoutParams) mSlideableView.getLayoutParams()).dimWhenOffset) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if (!mCanSlide || (mDragHelper.isViewUnder(mSlideableView, (int) ev.getX(), (int) ev.getY())
                        && !isDimmed(mSlideableView)
                        && ev.getRawX() > (DeviceUtils.getScreenWidth(getContext()) / 2))) {
                    return false;
                }
    ...
    void onPanelDragged(int newLeft) {
        ...
        final boolean isLayoutRtl = isLayoutRtlSupport();
        final MySlidingPaneLayout.LayoutParams lp = (MySlidingPaneLayout.LayoutParams) mSlideableView.getLayoutParams();
    ...
    private void dimChildView(View v, float mag, int fadeColor) {
        final MySlidingPaneLayout.LayoutParams lp = (MySlidingPaneLayout.LayoutParams) v.getLayoutParams();
        ...
        if (mag > 0 && fadeColor != 0) {
            ...
            final MySlidingPaneLayout.DisableLayerRunnable dlr = new MySlidingPaneLayout.DisableLayerRunnable(v);
    ...
    private void parallaxOtherViews(float slideOffset) {
        final boolean isLayoutRtl = isLayoutRtlSupport();
        final MySlidingPaneLayout.LayoutParams slideLp = (MySlidingPaneLayout.LayoutParams) mSlideableView.getLayoutParams();
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        return new MySlidingPaneLayout.LayoutParams();
    }

    @Override
    protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof ViewGroup.MarginLayoutParams
                ? new MySlidingPaneLayout.LayoutParams((ViewGroup.MarginLayoutParams) p)
                : new MySlidingPaneLayout.LayoutParams(p);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof MySlidingPaneLayout.LayoutParams && super.checkLayoutParams(p);
    }

    @Override
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new MySlidingPaneLayout.LayoutParams(getContext(), attrs);
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        MySlidingPaneLayout.SavedState ss = new MySlidingPaneLayout.SavedState(superState);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof MySlidingPaneLayout.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        MySlidingPaneLayout.SavedState ss = (MySlidingPaneLayout.SavedState) state;
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(View child, int pointerId) {
            ...
            return ((MySlidingPaneLayout.LayoutParams) child.getLayoutParams()).slideable;
        }
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            final MySlidingPaneLayout.LayoutParams lp = (MySlidingPaneLayout.LayoutParams) releasedChild.getLayoutParams();
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(@NonNull MySlidingPaneLayout.LayoutParams source) {
            super(source);
    ...
    static class SavedState extends AbsSavedState {
        ...
        public static final Creator<MySlidingPaneLayout.SavedState> CREATOR = new ClassLoaderCreator<MySlidingPaneLayout.SavedState>() {
            @Override
            public MySlidingPaneLayout.SavedState createFromParcel(Parcel in, ClassLoader loader) {
                return new MySlidingPaneLayout.SavedState(in, null);
            }

            @Override
            public MySlidingPaneLayout.SavedState createFromParcel(Parcel in) {
                return new MySlidingPaneLayout.SavedState(in, null);
            }

            @Override
            public MySlidingPaneLayout.SavedState[] newArray(int size) {
                return new MySlidingPaneLayout.SavedState[size];
            }
        };
    }
    ...
    static class SlidingPanelLayoutImplBase implements MySlidingPaneLayout.SlidingPanelLayoutImpl {
        @Override
    ...
    @RequiresApi(16)
    static class SlidingPanelLayoutImplJB extends MySlidingPaneLayout.SlidingPanelLayoutImplBase {
        /*
    ...
    @RequiresApi(17)
    static class SlidingPanelLayoutImplJBMR1 extends MySlidingPaneLayout.SlidingPanelLayoutImplBase {
        @Override
        public void invalidateChildRegion(MySlidingPaneLayout parent, View child) {
            ViewCompat.setLayerPaint(child, ((MySlidingPaneLayout.LayoutParams) child.getLayoutParams()).dimPaint);
        }
    }

...
import com.dzkandian.mvp.common.di.component.DaggerAgreementWebComponent;
import com.dzkandian.mvp.common.di.module.AgreementWebModule;
import com.dzkandian.mvp.common.presenter.AgreementWebPresenter;
...
public class AgreementWebActivity extends BaseActivity<AgreementWebPresenter> implements AgreementWebContract.View {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerAgreementWebComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_agreement_web; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }

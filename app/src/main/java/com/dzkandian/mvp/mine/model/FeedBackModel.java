...
public class FeedBackModel extends BaseModel implements FeedBackContract.Model {
    ...
    @NonNull
    @Override
    public Observable<BaseResponse<UserBean>> feedBack(String token, RequestBody requestBody) {
        return mRepositoryManager.obtainRetrofitService(BaseService.class).feedBack(token,requestBody);
    }
}
...
@ActivityScope
public class InviteDisciplePresenter extends BasePresenter<InviteDiscipleContract.Model, InviteDiscipleContract.View> {
    @Inject
    ...
    @Inject
    public InviteDisciplePresenter(@NonNull InviteDiscipleContract.Model model, @NonNull InviteDiscipleContract.View rootView) {
    ...
    public void apprenticesList(boolean isRefresh) {
        ...
        mModel.apprenticesList(getToken(), requestBody)
                ...
                .subscribe(new ErrorHandleSubscriber<List<ApprenticesBean>>(mErrorHandler) {
                    @Override
                    public void onNext(@Nullable List<ApprenticesBean> beanList) {

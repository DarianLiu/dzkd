...
public class CollectionVideoAdapter extends DefaultAdapter<CollectionVideoBean> {
    ...
    public CollectionVideoAdapter(List<CollectionVideoBean> infos) {
        super(infos);
    }
    ...
    public BaseHolder<CollectionVideoBean> getHolder(View v, int viewType) {
        return viewType == TYPE_DATA ? new CollectionVIdeoHolder(v) : new EmptyItemHolder(v);
    }
    ...
    public void onBindViewHolder(BaseHolder<CollectionVideoBean> holder, int position) {
        if (holder instanceof CollectionVIdeoHolder) {
            ...
            if (errorState == 2) {
                ...
                holder.setData(null, Constant.ERROR_EMPTY_COLLECTION_VIDEO);
            }
        }
    }
    ...
    public int getLayoutId(int viewType) {
        return viewType == TYPE_DATA ? R.layout.item_collection_video : R.layout.view_empty;
    }
}

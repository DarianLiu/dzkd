...
public class DanmuShortAdapter extends XAdapter<NewsDanmuBean> {
    ...
    public DanmuShortAdapter(Context c) {
        super();
        context = c;
        random = new Random();
    }
    ...
    public View getView(NewsDanmuBean danmuEntity, View convertView) {
        ...
        if (convertView == null) {
            ...
            DanmuShortAdapter.ViewHolder2 finalHolder = holder2;
            ...
            holder2.ll_danmu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    finalHolder.image.getLocationOnScreen(location);
                    ...
                    EventBus.getDefault().post(new DanmuEvent
                            ...
                            .build(), EventBusTags.TAG_SHORT_ANIMATION_THUBMS_UP);
                    Timber.d("====adapter     X" + viewX + "       Y" + viewY);
                    ...
                    if (!TextUtils.isEmpty(danmuEntity.getThumbsUpCount()) && danmuEntity.getCanThumbsUp()
                            && !TextUtils.isEmpty(danmuEntity.getPosition()) && isAllClick) { //是否可以点赞 true：可以；false：不可以
                        DanmuShortAdapter.this.mDanmuEntity = danmuEntity;
                        DanmuShortAdapter.this.holder2 = finalHolder;

                        EventBus.getDefault().post(danmuEntity.getPosition(), EventBusTags.TAG_SHORT_COMMENT_THUBMS_UP);

...
class ValueAnimatorCompatImplHoneycombMr1 extends ValueAnimatorCompat.Impl {
    ...
    @Override
    public void setUpdateListener(@NonNull final AnimatorUpdateListenerProxy updateListener) {
    ...
    @Override
    public void setListener(@NonNull final AnimatorListenerProxy listener) {

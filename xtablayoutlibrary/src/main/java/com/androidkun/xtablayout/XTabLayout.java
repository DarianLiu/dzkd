...
public class XTabLayout extends HorizontalScrollView {
    ...
    public XTabLayout(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XTabLayout(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
...
//        invalidate();
     ...
     */
    public void removeTab(@NonNull XTabLayout.Tab tab) {
        if (tab.mParent != this) {
    ...
    private void configureTab(@NonNull XTabLayout.Tab tab, int position) {
    ...
    private void addTabView(@NonNull XTabLayout.Tab tab, boolean setSelected) {
    ...
    private void addTabView(@NonNull XTabLayout.Tab tab, int position, boolean setSelected) {
        final XTabLayout.TabView tabView = tab.mView;
...
//            Log.w("BBB", "specWidth:" + specWidth);
        ...
        if (startScrollX != targetScrollX) {
            if (mScrollAnimator == null) {
                ...
                mScrollAnimator.setUpdateListener(new ValueAnimatorCompat.AnimatorUpdateListener() {
                    @Override
                    public void onAnimationUpdate(@NonNull ValueAnimatorCompat animator) {
    ...
    void selectTab(@NonNull XTabLayout.Tab tab) {
        selectTab(tab, true);
    }

    void selectTab(@NonNull XTabLayout.Tab tab, boolean updateIndicator) {
        if (mSelectedTab == tab) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
               ...
               /* int maxWidth = mIndicatorRight - mIndicatorLeft;
                ...
                if (mSelectedIndicatorWidth != 0 && !xTabDividerWidthWidthText) {
                    ...
                    int maxWidth = mIndicatorRight - mIndicatorLeft;
                    if (mSelectedTab!=null&&maxWidth > mSelectedTab.getTextWidth()) {
